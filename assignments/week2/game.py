...
# Final remarks are written at the bottom.
...
def type(text):
   for character in text:
      ...
      time.sleep(0.0001)
   print()
# Used a tutorial to create a typewriter effect (segment above). This was done after everything else was coded.
...
# There is also only one ending, which is unfortunate, but there is incentive for replayability (although almost everything relies on RNG).
